...
WORDLIST_FILENAME = "C:\Users\Clive\Python\MITx-6.00.1x\Problem Set 4\words.txt"
...
def isValidWord(word, hand, wordList):
    ...
    updatedHand = hand.copy()
    for char in word:
        char_count = updatedHand.get(char, 0)
        if char_count == 0:
            return False
        updatedHand[char] = updatedHand[char] - 1
    return True
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    if calculateHandlen(current_hand) == 0:
        print 'Ran out of letters. Total score: ' + str(current_score) + ' points.'
    else:
        print 'Goodbye! Total score: ' + str(current_score) + ' points.'
